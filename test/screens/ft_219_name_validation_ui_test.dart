...
void main() {
  group('FT-219: Name Validation UI Fix', () {
    testWidgets('should not show error message on initial load', (tester) async {
      // Build the widget
    ...
    testWidgets('should show error when user enters invalid input', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: NameSetupScreen(
            onContinue: () {},
    ...
    testWidgets('should enable button when valid name is entered', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: NameSetupScreen(
            onContinue: () {},
    ...
    testWidgets('should handle button state transitions correctly', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: NameSetupScreen(
            onContinue: () {},
